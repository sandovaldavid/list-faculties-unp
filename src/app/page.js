        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 py-24 md:py-32 text-white overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row items-center">
                        <div className="lg:w-1/2 mb-12 lg:mb-0 lg:pr-10 animate-fade-in-up">
                            ...
                            <p className="text-xl mb-8 opacity-90 text-blue-100 max-w-2xl leading-relaxed">
                                Plataforma integral para la administración académica. Gestiona tus
                                facultades de manera sencilla, moderna y eficiente.
                            </p>
                ...
                <div className="absolute bottom-0 left-0 right-0">
                    <svg
                        className="w-full h-16 md:h-20 fill-current text-gray-50"
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Nuestro sistema ofrece herramientas completas para la gestión de
                    ...
                    <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-blue-100 group">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Registra nuevas facultades con toda su información relevante y carga
                                imágenes representativas en un proceso simple y guiado.
                            </p>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-blue-100 group">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Edita y actualiza la información de tus facultades en cualquier
                                momento con nuestra interfaz intuitiva y herramientas de edición
                                avanzadas.
                            </p>
                            <div className="mt-6 text-blue-600 font-medium inline-flex items-center text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <span>Explorar función</span>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-blue-100 group">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Visualiza todas las facultades en un diseño moderno y responsive,
                                optimizado para cualquier dispositivo y con filtros de búsqueda
                                inteligentes.
                            </p>
                            <div className="mt-6 text-blue-600 font-medium inline-flex items-center text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <span>Explorar función</span>
            ...
            <div className="relative h-24 bg-white overflow-hidden">
                <svg
                    className="absolute bottom-0 left-0 w-full h-24 -mb-0.5"
                ...
                <section className="py-20 bg-gray-50">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            ...
                            <div className="w-24 h-1 bg-blue-600 mx-auto mb-6 rounded-full"></div>
                            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                                Descubre algunas de las facultades disponibles en nuestro sistema
                                académico.
                            </p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
                            <div className="flex items-center mb-4">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Director de Facultad de Ciencias
                                    </p>
                                </div>
                            ...
                            <p className="text-gray-700 italic leading-relaxed">
                                &quot;Este sistema ha simplificado enormemente la gestión de
                                información académica en nuestra facultad. La interfaz es intuitiva
                                y nos permite mantener toda la información actualizada de manera
                                eficiente.&quot;
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <p className="text-gray-700 italic leading-relaxed">
                                &quot;La capacidad de gestionar las facultades con esta plataforma
                                ha mejorado la organización de nuestra universidad. Es una
                                herramienta indispensable para la administración académica
                                moderna.&quot;
                            </p>
                        </div>
                    </div>
            ...
            <section className="relative bg-gradient-to-r from-blue-800 to-blue-600 py-20 overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <p className="text-xl mb-10 max-w-2xl mx-auto text-blue-100">
                        Sistema de Gestión de Facultades UNP - La plataforma integral para la
                        Universidad Nacional de Piura.
                    </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-3xl mx-auto space-y-6">
                        <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Para crear una nueva facultad, haz clic en el botón &quot;Nueva
                                Facultad&quot; en la barra de navegación o en la página principal.
                                Completa el formulario con la información requerida y sube una
                                imagen representativa si lo deseas.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Sí, puedes editar cualquier facultad existente. Simplemente ve a la
                                página de detalles de la facultad y haz clic en el botón
                                &quot;Editar&quot;. Podrás modificar toda la información, incluyendo
                        ...
                        <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Puedes subir imágenes en formatos JPG, PNG o WebP. Recomendamos
                                utilizar imágenes de alta calidad con resolución de al menos
                                1200x800 píxeles para una mejor visualización.
                            </p>
                        </div>
                    </div>
                </div>
