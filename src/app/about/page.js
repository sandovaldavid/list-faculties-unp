		...
		<div className='container mx-auto px-4 py-16 mt-16 max-w-6xl'>
			...
			<section className='text-center mb-16 animate-fade-in'>
				...
				<p className='text-xl text-gray-300 max-w-3xl mx-auto'>
					Una plataforma diseñada para la gestión eficiente de las
			...
			<section className='mb-16 bg-zinc-800/50 p-8 rounded-lg animate-fade-in'>
				...
				<p className='text-gray-300 mb-6'>
					Este sistema forma parte de mi portafolio profesional como
					desarrollador. Representa mi capacidad para crear
					aplicaciones web completas con arquitecturas modernas y
					eficientes. Puedes visitar mi portafolio completo para ver
			...
			<section className='mb-16 grid md:grid-cols-2 gap-8 items-center'>
				<div className='animate-fade-in-up'>
					...
					<p className='text-gray-300 mb-4'>
						Fundada el 3 de marzo de 1961, la Universidad Nacional
						de Piura es una institución pública de educación
						superior ubicada en el norte del Perú.
					</p>
					<p className='text-gray-300 mb-4'>
						Con más de 60 años de trayectoria, la UNP ha formado a
						generaciones de profesionales comprometidos con el
						desarrollo de la región Piura y del país.
					</p>
			...
			<section className='mb-16 bg-zinc-800/50 p-8 rounded-lg animate-fade-in'>
				...
				<p className='text-gray-300 mb-6'>
					Este proyecto es una solución web creada para mi portafolio
					profesional que demuestra mis capacidades de desarrollo en
					Next.js, API REST, y diseño de interfaces con TailwindCSS.
					El sistema tiene como objetivo proporcionar una forma
					eficiente de gestionar la información de las facultades de
				...
				<div className='grid md:grid-cols-3 gap-6'>
					<div className='bg-zinc-800 p-6 rounded-lg shadow hover-lift'>
						...
						<p className='text-gray-300'>
							Facilitar la administración de las facultades
							universitarias mediante un sistema CRUD intuitivo y
							eficiente, demostrando buenas prácticas de
							desarrollo.
						</p>
					</div>
					<div className='bg-zinc-800 p-6 rounded-lg shadow hover-lift'>
						...
						<p className='text-gray-300'>
							Desarrollado con Next.js, TailwindCSS y MySQL para
							garantizar rendimiento, escalabilidad y una
					...
					<div className='bg-zinc-800 p-6 rounded-lg shadow hover-lift'>
						...
						<p className='text-gray-300'>
							Creación, visualización, actualización y eliminación
							de facultades, con gestión de imágenes y validación
						...
						<div className='relative'>
							...
							<div className='ml-4 md:ml-0 md:w-1/2 md:pr-8 md:text-right'>
								<div className='bg-zinc-800 p-5 rounded-lg shadow-lg md:ml-auto md:mr-8'>
									...
									<p className='text-gray-300'>
										Lanzamiento inicial con funcionalidades
										básicas CRUD para la gestión de
										facultades.
									</p>
								</div>
							</div>
							...
							<div className='ml-4 md:ml-auto md:w-1/2 md:pl-8 md:text-left'>
								<div className='bg-zinc-800 p-5 rounded-lg shadow-lg md:mr-auto md:ml-8'>
									...
									<p className='text-gray-300'>
										...
										optimización del rendimiento y adición
							...
							<div className='ml-4 md:ml-0 md:w-1/2 md:pr-8 md:text-right'>
								<div className='bg-zinc-800 p-5 rounded-lg shadow-lg md:ml-auto md:mr-8'>
									...
									<p className='text-gray-300'>
										...
										para gestión de docentes y programas
										académicos.
									</p>
								</div>
							</div>
				...
				<div className='grid md:grid-cols-1 lg:grid-cols-1 gap-6'>
					<div className='bg-zinc-800 p-6 rounded-lg shadow-lg text-center hover-lift'>
						...
						<p className='text-gray-300 text-sm'>
							Responsable del diseño y desarrollo completo del
							sistema. Especializado en Next.js, React,
							TailwindCSS y desarrollo de APIs RESTful.
						</p>
						<div className='mt-4'>
							<a
								href='https://devsandoval.me'
			...
			<section className='text-center animate-fade-in'>
				...
				<p className='text-gray-300 mb-8 max-w-2xl mx-auto'>
					Si tienes preguntas sobre este proyecto o estás interesado
					en trabajar conmigo, no dudes en contactarme a través de mis
					redes sociales o directamente por correo.
				</p>
