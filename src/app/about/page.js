  ...
  return (
    <div className="container mx-auto px-4 py-16 mt-16 max-w-6xl">
      ...
      <section className="text-center mb-16 animate-fade-in">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Acerca del Sistema</h1>
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          Una plataforma diseñada para la gestión eficiente de las facultades
      ...
      <section className="mb-16 bg-zinc-800/50 p-8 rounded-lg animate-fade-in">
        ...
        <p className="text-gray-300 mb-6">
          Este sistema forma parte de mi portafolio profesional como desarrollador. Representa
          mi capacidad para crear aplicaciones web completas con arquitecturas modernas y eficientes.
          Puedes visitar mi portafolio completo para ver más proyectos similares.
        </p>
      ...
      <section className="mb-16 grid md:grid-cols-2 gap-8 items-center">
        <div className="animate-fade-in-up">
          <h2 className="text-3xl font-bold mb-4 text-white">Universidad Nacional de Piura</h2>
        ...
        <div className="bg-zinc-800 p-6 rounded-lg shadow-xl animate-scale-in">
          <div className="aspect-video relative rounded-md overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center bg-zinc-900 text-white">
              <span className="text-lg font-semibold">Universidad Nacional de Piura</span>
            </div>
          </div>
          <div className="mt-4">
      ...
      {/* Project Information */}
      <section className="mb-16 bg-zinc-800/50 p-8 rounded-lg animate-fade-in">
        <h2 className="text-3xl font-bold mb-6 text-white">Sistema de Gestión de Facultades</h2>
        <p className="text-gray-300 mb-6">
          Este proyecto es una solución web creada para mi portafolio profesional que demuestra
          mis capacidades de desarrollo en Next.js, API REST, y diseño de interfaces con TailwindCSS.
          El sistema tiene como objetivo proporcionar una forma eficiente de gestionar la información
          de las facultades de la Universidad Nacional de Piura.
        </p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-zinc-800 p-6 rounded-lg shadow hover-lift">
            ...
            <p className="text-gray-300">
              Facilitar la administración de las facultades universitarias mediante
              un sistema CRUD intuitivo y eficiente, demostrando buenas prácticas de desarrollo.
            </p>
          </div>
          <div className="bg-zinc-800 p-6 rounded-lg shadow hover-lift">
          ...
          <div className="bg-zinc-800 p-6 rounded-lg shadow hover-lift">
            ...
            <p className="text-gray-300">
              Creación, visualización, actualización y eliminación de facultades,
              con gestión de imágenes y validación de datos en tiempo real.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16 animate-fade-in-up">
        <h2 className="text-3xl font-bold mb-8 text-white text-center">Desarrollo del Proyecto</h2>
        <div className="relative">
          ...
          <div className="space-y-12">
            <div className="relative">
              ...
              <div className="ml-4 md:ml-0 md:w-1/2 md:pr-8 md:text-right">
                <div className="bg-zinc-800 p-5 rounded-lg shadow-lg md:ml-auto md:mr-8">
                  ...
                  <time className="text-sm text-blue-400 mb-2 block">Enero 2025</time>
                  <p className="text-gray-300">
                    Lanzamiento inicial con funcionalidades básicas CRUD para la gestión de facultades.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="ml-4 md:ml-auto md:w-1/2 md:pl-8 md:text-left">
                <div className="bg-zinc-800 p-5 rounded-lg shadow-lg md:mr-auto md:ml-8">
                  ...
                  <time className="text-sm text-blue-400 mb-2 block">Abril 2025</time>
                  <p className="text-gray-300">
                    Mejoras en la interfaz de usuario, optimización del rendimiento y adición de funcionalidades avanzadas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="ml-4 md:ml-0 md:w-1/2 md:pr-8 md:text-right">
                <div className="bg-zinc-800 p-5 rounded-lg shadow-lg md:ml-auto md:mr-8">
                  <h3 className="text-xl font-bold text-white">Próximas Actualizaciones</h3>
                  <time className="text-sm text-blue-400 mb-2 block">Planificado</time>
                  <p className="text-gray-300">
                    Implementación de módulos adicionales para gestión de docentes y programas académicos.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="text-center animate-fade-in">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          ...
          no dudes en contactarme a través de mis redes sociales o directamente por correo.
        </p>
