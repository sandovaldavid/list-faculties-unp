        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <div className="flex flex-col leading-none">
                <h3 className={`text-lg md:text-xl font-bold transition-colors duration-300 ${scrolled ? 'text-zinc-800' : 'text-white'}`}>
                  Facultades UNP
                </h3>
                <span className="text-xs opacity-75 hidden sm:block">Universidad Nacional de Piura</span>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            >
              ...
              {pathname === '/faculties' && (
                <span className={`absolute bottom-0 left-0 w-full h-0.5 ${scrolled ? 'bg-blue-600' : 'bg-blue-400'}`}></span>
              )}
            </Link>
