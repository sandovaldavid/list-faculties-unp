                            ...
                            {existingImage && !file && (
                                <div className="mb-4 relative">
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className={`absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center transition-opacity duration-300 ${imagePreviewHover ? 'opacity-100' : 'opacity-0'}`}
                                        >
                                            <button
                                                type="button"
                                ...
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-center justify-center">
                                        <label className="relative cursor-pointer rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                            <span>
                                                {file ? 'Cambiar imagen' : 'Subir una imagen'}
                                            </span>
                                            <input
                                                ref={fileInputRef}
                                                id="file-upload"
